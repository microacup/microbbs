 ...
 * <p>
 * Key method of interest is {@link this.getIdenticonCode} which converts IP address
...
public class IdenticonUtil {
	private static final Logger log = LoggerFactory.getLogger(IdenticonUtil.class);
