...
public class RedisCacheManager extends AbstractCacheManager {
    ...
    private final RedisTemplate<? extends Object, ? extends Object> defaultTemplate;
    private final Map<String, RedisTemplate<? extends Object, ? extends Object>> templates;
    ...
    public RedisCacheManager(RedisConnectionFactory redisConnectionFactory) {
        ...
        this.defaultTemplate = new StringRedisTemplate();
    ...
    public RedisCacheManager withCache(String cacheName, RedisTemplate<? extends Object, ? extends Object> template, long expiration) {
        ...
        addCache(cache);*/ // @use getMissingCache
        return this;
    }
